...
#        wcs.ctype = ["Azimuth--DEG", "ELEVATION--DEG"]
    ...
    def read_data(self, *args, **kwargs):
        ...
        for ckey in self.__dataSc.keys():
            ...
            if ckey in ['F_azimuth', 'F_elevation']: 
                # convert units of azimuth and elevation to degs. 
        ...
        if ['F_azimuth', 'F_elevation'] <= list(self.__dataSc.keys()):
            ...
            self.az_sky, self.el_sky = KISSpm.telescope2sky(self.az_tel,self.el_tel)
            self.az_skyQ1, self.el_skyQ1 = KISSpmQ1.telescope2sky(self.az_tel,self.el_tel)
